...
export type NavItem = { label: string; href: string; icon: string; children?: NavChild[]; disabled?: boolean; badge?: string };

const PROFILE_ITEM: NavItem = { label: "My Profile", href: "/dashboard/profile", icon: "user" };

const BENEFICIARY_NAV: NavItem[] = [
  { label: "Overview", href: "/dashboard", icon: "home" },
  { label: "My Applications", href: "/dashboard/applications", icon: "doc" },
...
const FINANCE_NAV: NavItem[] = [
  ...
  { label: "Applications", href: "/dashboard/applications", icon: "doc" },
  { label: "Beneficiaries", href: "/dashboard/beneficiaries", icon: "heart" },
  { label: "Notifications", href: "/dashboard/notifications", icon: "bell" },
  PROFILE_ITEM,
];
...
export function navForRole(role: string, opts: { empowermentOpen?: boolean } = {}): NavItem[] {
  ...
  const items: NavItem[] = [
    ...
    { label: "Beneficiaries", href: "/dashboard/beneficiaries", icon: "heart", children: BENEFICIARIES_CHILDREN },
  ...
  if (role === ROLES.EXECUTIVE || role === ROLES.ADMIN) {
    items.push(
      ...
      { label: "Users", href: "/dashboard/users", icon: "cog" },
      { label: "Form Builder", href: "/dashboard/form-fields", icon: "doc" },
